...
public class Janela extends JFrame 
{
    ...
    public Janela ()
    {
        ...
        try
        {
            Image btnTintaImg = ImageIO.read(getClass().getResource("resources/tinta.jpg"));
        ...
        btnPoligono.addActionListener (new DesenhoDeQuadrado ());
        btnTinta.addActionListener (new TrocaCor ());
